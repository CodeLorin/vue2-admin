    ...
    <div class="nav-container">
        ...
        <div class="right-container">
            ...
            <el-tooltip content="当前用户" placement="bottom" style="margin-right: 1rem">
                <el-tag
                    >登录用户:&nbsp;<span style="font-weight: bold">{{
                        userInfo.username
                    }}</span></el-tag
                >
            </el-tooltip>
            <el-dropdown class="dropdown" @command="handleCommand" trigger="click">
                ...
                <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item icon="iconfont icon-gerenzhongxin" command="userCenter"
                        >个人中心</el-dropdown-item
                    >
                    <el-dropdown-item icon="iconfont icon-tuichu" command="logout"
