            ...
            <div class="login-container">
                <div class="login-form">
                    ...
                    <el-form :model="loginForm" :rules="loginRules" ref="loginForm">
                        ...
                        <el-form-item prop="password" class="password" style="">
                            <el-input
                        ...
                        <el-form-item prop="captcha" class="captcha" style="">
                            <el-input
                        ...
                        <el-form-item class="tool">
                            <el-checkbox v-model="rememberMe" name="remember-me"
                                >记住密码
                            </el-checkbox>
                            <i
                                class="el-icon-warning-outline forget"
...
import { captcha } from "../api/user/login"
import qs from "qs"
...
export default {
    ...
    data() {
        return {
            loginForm: { username: "", password: "", captcha: "", token: "" },
            captchaImg: "",
            rememberMe: false,
            loginRules: {
    ...
    methods: {
        ...
        changePasswordType() {
            if (this.passwordIcon === "icon-eye1") {
                this.passwordType = "text"
                this.passwordIcon = "icon-eye"
                return
            }
